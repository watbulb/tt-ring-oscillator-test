...
N 470 120 540 120 {
lab=ENABLE}
C {devices/code_shown.sym} 940 290 0 0 {name=CONTROL only_toplevel=false value="
.control
...
.option warn=1
"}
C {tt-ring-oscillator-test-hd.sym} 610 120 0 0 {name=x1}
...
C {spice_probe.sym} 240 50 0 0 {name=p7 attrs=""}
C {spice_probe.sym} 140 50 0 0 {name=p8 attrs=""}
C {spice_probe.sym} 60 50 0 0 {name=p10 attrs=""}
C {devices/lab_wire.sym} 470 120 0 0 {name=p4 sig_type=std_logic lab=ENABLE}
C {devices/lab_wire.sym} 600 60 0 1 {name=p5 sig_type=wire lab=VDD}
C {devices/lab_wire.sym} 600 180 2 0 {name=p6 sig_type=wire lab=VSS}
C {devices/lab_wire.sym} 730 90 2 0 {name=p3 sig_type=wire lab=OSC_DRIVE_OUT}
